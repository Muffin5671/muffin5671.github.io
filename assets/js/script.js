...
function editErrorText() {
  document.getElementById('errortext').innerHTML = `The requested file ${document.location.pathname} was not hosted on the server. (404)`;
}

window.onload = editErrorText;
